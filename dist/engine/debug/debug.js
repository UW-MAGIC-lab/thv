...
},{}],"../node_modules/@aegis-framework/artemis/src/Debug.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Debug = exports.DebugLevel = void 0;
  ...
  _createClass(Debug, null, [{
    ...
    value: function table() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console6 = console).table.apply(_console6, arguments);
      }
    }
    /**
    ...
    value: function group() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console7 = console).group.apply(_console7, arguments);
      }
    }
    /**
    ...
    value: function groupCollapsed() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console8 = console).groupCollapsed.apply(_console8, arguments);
      }
    }
    /**
    ...
    value: function groupEnd() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console9 = console).groupEnd.apply(_console9, arguments);
      }
    }
    /**
    ...
    value: function time() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console10 = console).time.apply(_console10, arguments);
      }
    }
    /**
    ...
    value: function timeLog() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console11 = console).timeLog.apply(_console11, arguments);
      }
    }
    /**
    ...
    value: function timeEnd() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console12 = console).timeEnd.apply(_console12, arguments);
      }
    }
    /**
    ...
    value: function trace() {
      if (this.level() >= DebugLevel.DEBUG) {
        ...
        (_console13 = console).trace.apply(_console13, arguments);
      }
    }
  }]);
...
},{}],"../node_modules/@aegis-framework/artemis/src/DOM.js":[function(require,module,exports) {
"use strict";
...
var DOM = /*#__PURE__*/function () {
  ...
  _createClass(DOM, [{
    ...
    value: function removeClass() {
      var oldClass = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      ...
      if (oldClass !== null) {
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            while (_element.classList.length > 0) {
              _element.classList.remove(_element.classList.item(0));
            }
          }
        } catch (err) {
          _iterator5.e(err);
    ...
    value: function toggleClass(classes) {
      ...
      var _iterator6 = _createForOfIteratorHelper(this.collection),
          _step6;
    ...
    value: function hasClass(classToCheck) {
      var _iterator7 = _createForOfIteratorHelper(this.collection),
          _step7;
    ...
    value: function value(_value) {
      if (typeof _value !== 'undefined') {
        var _iterator8 = _createForOfIteratorHelper(this.collection),
            _step8;
    ...
    value: function click(callback) {
      var _iterator9 = _createForOfIteratorHelper(this.collection),
          _step9;
    ...
    value: function keyup(callback) {
      var _iterator10 = _createForOfIteratorHelper(this.collection),
          _step10;
    ...
    value: function keydown(callback) {
      var _iterator11 = _createForOfIteratorHelper(this.collection),
          _step11;
    ...
    value: function submit(callback) {
      var _iterator12 = _createForOfIteratorHelper(this.collection),
          _step12;
    ...
    value: function change(callback) {
      var _iterator13 = _createForOfIteratorHelper(this.collection),
          _step13;
    ...
    value: function scroll(callback) {
      var _iterator14 = _createForOfIteratorHelper(this.collection),
          _step14;
    ...
    value: function on(event, target, callback) {
      ...
      var _iterator15 = _createForOfIteratorHelper(this.collection),
          _step15;
          ...
          for (var j = 0; j < event.length; j++) {
            ...
            if (typeof target === 'function') {
              ...
              element.addEventListener(event[j], function (e) {
                ...
                var targetElement = $_(e.target).closestParent(target, _this._selector);
    ...
    value: function data(name, value) {
      if (typeof value !== 'undefined') {
        var _iterator16 = _createForOfIteratorHelper(this.collection),
            _step16;
    ...
    value: function html(value) {
      if (typeof value !== 'undefined') {
        var _iterator19 = _createForOfIteratorHelper(this.collection),
            _step19;
    ...
    value: function each(callback) {
      var _iterator20 = _createForOfIteratorHelper(this.collection),
          _step20;
    ...
    value: function isVisible() {
      var _iterator21 = _createForOfIteratorHelper(this.collection),
          _step21;
    ...
    key: "closestParent",
    value: function closestParent(selector, limit) {
      var element = this;
    ...
    value: function attribute(_attribute, value) {
      if (typeof value !== 'undefined') {
        var _iterator22 = _createForOfIteratorHelper(this.collection),
            _step22;
        ...
        if (this.length > 0) {
          return this.collection[0].getAttribute(_attribute);
        }
      }
    }
    /**
    ...
    value: function hasAttribute(attribute) {
      var _iterator23 = _createForOfIteratorHelper(this.collection),
          _step23;
    ...
    value: function after(content) {
      var _iterator24 = _createForOfIteratorHelper(this.collection),
          _step24;
    ...
    value: function before(content) {
      var _iterator25 = _createForOfIteratorHelper(this.collection),
          _step25;
    ...
    key: "style",
    value: function style(properties, value) {
    ...
    key: "animate",
    value: function animate(style, time) {
      var _this2 = this;
      ...
      var _loop = function _loop(i) {
        var _loop2 = function _loop2(property) {
          ...
          if (typeof _this2.collection[i].style[property] !== 'undefined') {
            initialValue = _this2.collection[i].style[property];
            ...
            _this2.collection[i].style[property] = initialValue;
          } else if (typeof _this2.collection[i][property] !== 'undefined') {
            initialValue = _this2.collection[i][property];
            timer = setInterval(function () {
              var step = Math.min(1, (new Date().getTime() - start) / time);
            ...
            _this2.collection[i][property] = initialValue;
          }
        };
    ...
    value: function remove() {
      var _iterator26 = _createForOfIteratorHelper(this.collection),
          _step26;
    ...
    value: function replaceWith(newElement) {
      ...
      var _iterator27 = _createForOfIteratorHelper(this.collection),
          _step27;
    ...
    value: function reset() {
      var _iterator28 = _createForOfIteratorHelper(this.collection),
          _step28;
    ...
    key: "property",
    value: function property(_property, value) {
      if (typeof value !== 'undefined') {
        var _iterator29 = _createForOfIteratorHelper(this.collection),
            _step29;
        ...
        if (this.length > 0) {
          return this.collection[0][_property];
        }
      }
    }
  }]);
...
},{}],"../node_modules/@aegis-framework/artemis/src/Request.js":[function(require,module,exports) {
"use strict";
...
var Request = /*#__PURE__*/function () {
  ...
  _createClass(Request, null, [{
    ...
    value: function get(url) {
      ...
      var query = Request.serialize(data); // Check if there is actually any data parameters and join them to the
    ...
    value: function post(url, data) {
      ...
      var props = Object.assign({}, {
        ...
        body: formData
      }, options); // Delete the explicit multipart/form-data header to allow boundary automatic filling
    ...
    value: function put(url, data) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return Request.post(url, data, Object.assign({}, {
        method: 'PUT'
      }, options));
    }
    /**
    ...
    value: function _delete(url, data) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return Request.get(url, data, Object.assign({}, {
        method: 'DELETE'
      }, options));
    }
    /**
    ...
    value: function json(url) {
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return Request.get(url, data, options).then(function (response) {
...
},{}],"../node_modules/@aegis-framework/artemis/src/FileSystem.js":[function(require,module,exports) {
"use strict";
...
var FileSystem = /*#__PURE__*/function () {
  ...
  _createClass(FileSystem, null, [{
    ...
    function readRemote(url) {
      ...
      return _Request.Request.blob(url, {}, props).then(function (file) {
    ...
    key: "create",
    value: function create(name, content) {
      var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'text/plain';
      return Promise.resolve(new File([content], name, {
        type: type
      }));
    }
    /**
    ...
    key: "isImage",
    value: function isImage(name) {
      var extensions = ['jpg', 'jpeg', 'png', 'gif', 'svg', 'webp', 'bmp'];
...
},{"./Request":"../node_modules/@aegis-framework/artemis/src/Request.js"}],"../node_modules/@aegis-framework/artemis/src/Form.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Form, null, [{
    ...
    function fill(name, data) {
      for (var field in data) {
        var element = (0, _DOM.$_)("form[data-form='".concat(name, "'] [name='").concat(field, "']")).get(0);
    ...
    value: function values(name) {
      var data = {};
      (0, _DOM.$_)("form[data-form='".concat(name, "'] [name]")).each(function (element) {
        var value;
...
exports.Form = Form;
},{"./DOM":"../node_modules/@aegis-framework/artemis/src/DOM.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"../node_modules/@aegis-framework/artemis/src/Platform.js":[function(require,module,exports) {
...
var Platform = /*#__PURE__*/function () {
  ...
  _createClass(Platform, null, [{
    ...
    value: function electron() {
      ...
      if ((typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) === 'object' && typeof navigator.userAgent === 'string' && navigator.userAgent.indexOf('Electron') > -1) {
        return true;
      }
    ...
    value: function desktop() {
      var platform = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Any';
      var match = false;
      ...
      switch (platform) {
        ...
        case 'Any':
        default:
          match = navigator.platform.includes('Win') || navigator.platform.includes('Mac') || navigator.platform.includes('Linux') || navigator.platform.includes('FreeBSD') || navigator.platform.includes('WebTV');
          break;
      }
...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/@aegis-framework/artemis/src/Preload.js":[function(require,module,exports) {
"use strict";
...
var Preload = /*#__PURE__*/function () {
  ...
  _createClass(Preload, null, [{
    ...
    key: "file",
    value: function file(route) {
      return _Request.Request.blob(route);
    }
  }]);
...
},{"./Request":"../node_modules/@aegis-framework/artemis/src/Request.js"}],"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/LocalStorage.js":[function(require,module,exports) {
"use strict";
...
var LocalStorage = /*#__PURE__*/function () {
  ...
  function LocalStorage(_ref) {
    ...
    if (name !== '' && version !== '' && store !== '') {
      this.id = "".concat(this.name, "::").concat(this.store, "::").concat(this.version, "_");
    } else if (name !== '' && version !== '') {
      this.id = "".concat(this.name, "::").concat(this.version, "_");
    } else if (name !== '') {
      this.id = "".concat(this.name, "::_");
    } else {
      this.id = '';
    }
  }
  ...
  _createClass(LocalStorage, [{
    ...
    value: function open() {
      ...
      if (_typeof(this.storage) === 'object' && !(this.storage instanceof Promise)) {
        return Promise.resolve(this);
      } else if (this.storage instanceof Promise) {
        return this.storage;
      } else {
        this.storage = new Promise(function (resolve) {
          var upgradesToApply = []; // Check if this space is versioned
          ...
          if (_this.version !== '') {
            ...
            if (_this.name !== '' && _this.version !== '' && _this.store !== '') {
              versionless = "".concat(_this.name, "::").concat(_this.store, "::");
            } else if (_this.name !== '' && _this.version !== '') {
              versionless = "".concat(_this.name, "::");
            } // Get all the currently stored keys that contain the versionless
            // ID, which means they belong to this space


            var storedVersions = Object.keys(window.localStorage).filter(function (key) {
            ...
            if (storedVersions.length > 0) {
              ...
              var oldVersion = storedVersions[0];
              var oldVersionNumeric = parseInt(oldVersion.replace(/\./g, ''));

              if (oldVersionNumeric < _this.numericVersion) {
                // Check what upgrade functions have been declared in their respective order
                var availableUpgrades = Object.keys(_this.upgrades).sort(); // Find the first update that needs to be applied to the database given
                // the old version it currently has.

                var startFrom = availableUpgrades.findIndex(function (u) {
                  var _u$split = u.split('::'),
                      _u$split2 = _slicedToArray(_u$split, 1),
                      old = _u$split2[0];
                ...
                if (startFrom > -1) {
                  upgradesToApply = availableUpgrades.slice(startFrom).filter(function (u) {
                    var _u$split3 = u.split('::'),
                        _u$split4 = _slicedToArray(_u$split3, 2),
                        old = _u$split4[0],
                        next = _u$split4[1];

                    return parseInt(old) < _this.numericVersion && parseInt(next) <= _this.numericVersion;
                  });
                } // Get the previous ID using the old version


                var previousId = "".concat(_this.name, "::").concat(oldVersion, "_");

                if (_this.name !== '' && _this.version !== '' && _this.store !== '') {
                  previousId = "".concat(_this.name, "::").concat(_this.store, "::").concat(oldVersion, "_");
                } else if (_this.name !== '' && _this.version !== '') {
                  previousId = "".concat(_this.name, "::").concat(oldVersion, "_");
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    var previous = window.localStorage.getItem("".concat(previousId).concat(key)); // Re-insert the value using the new ID as a key

                    window.localStorage.setItem(_this.id + key, previous); // Delete the previous value.

                    window.localStorage.removeItem("".concat(previousId).concat(key));
                  }
                } catch (err) {
                  _iterator.e(err);
                } finally {
    ...
    value: function set(key, value) {
      ...
      return this.open().then(function () {
        if (_typeof(value) === 'object') {
          _this2.storage.setItem(_this2.id + key, JSON.stringify(value));
        } else {
          _this2.storage.setItem(_this2.id + key, value);
        }
    ...
    value: function update(key, value) {
      ...
      return this.get(key).then(function (currentValue) {
        if (_typeof(currentValue) === 'object') {
          if (_typeof(value) === 'object') {
            value = Object.assign({}, currentValue, value);
          }

          _this3.storage.setItem(_this3.id + key, JSON.stringify(value));
        } else {
          _this3.storage.setItem(_this3.id + key, value);
        }
    ...
    value: function get(key) {
      ...
      return this.open().then(function () {
        return new Promise(function (resolve, reject) {
          var value = null;
          value = _this4.storage.getItem(_this4.id + key);
          ...
          } catch (exception) {// Unable to parse to JSON
          }
      ...
      return this.keys().then(function (keys) {
        ...
        try {
          var _loop = function _loop() {
            ...
            promises.push(_this5.get(key).then(function (value) {
              values[key] = value;
            }));
          };
    ...
    key: "upgrade",
    value: function upgrade(oldVersion, newVersion, callback) {
      this.upgrades["".concat(parseInt(oldVersion.replace(/\./g, '')), "::").concat(parseInt(newVersion.replace(/\./g, '')))] = callback;
      return Promise.resolve();
    ...
    key: "_upgrade",
    value: function _upgrade(upgradesToApply, resolve) {
      var _this6 = this;

      // Check if there are still upgrades to apply
      if (upgradesToApply.length > 0) {
        this.upgrades[upgradesToApply[0]].call(this, this).then(function () {
          _this6._upgrade(upgradesToApply.slice(1), resolve);
        }).catch(function (e) {
    ...
    value: function rename(name) {
      ...
      if (this.name !== name) {
        return this.keys().then(function (keys) {
          ...
          var oldId = _this7.id; // Set new object properties with the new name

          _this7.name = name;

          if (_this7.name !== '' && _this7.version !== '' && _this7.store !== '') {
            _this7.id = "".concat(_this7.name, "::").concat(_this7.store, "::").concat(_this7.version, "_");
          } else if (_this7.name !== '' && _this7.version !== '') {
            _this7.id = "".concat(_this7.name, "::").concat(_this7.version, "_");
          } else if (_this7.name !== '') {
            _this7.id = "".concat(_this7.name, "::_");
          } else {
            _this7.id = '';
          }
          ...
          try {
            var _loop2 = function _loop2() {
              ...
              promises.push(_this7.set(key, _this7.storage.getItem("".concat(oldId).concat(key))).then(function () {
                _this7.storage.removeItem("".concat(oldId).concat(key));
              }));
            };
    ...
    value: function key(index) {
      ...
      return this.open().then(function () {
        if (full === true) {
          return Promise.resolve(_this8.storage.key(index));
        } else {
          return Promise.resolve(_this8.storage.key(index).replace(_this8.id, ''));
        }
      });
    }
    /**
    ...
    value: function keys() {
      ...
      return this.open().then(function () {
        return Promise.resolve(Object.keys(_this9.storage).filter(function (key) {
          return key.indexOf(_this9.id) === 0;
        }).map(function (key) {
          if (full === true) {
            return key;
          } else {
            return key.replace(_this9.id, '');
          }
        }));
      });
    }
    ...
    value: function remove(key) {
      ...
      return this.get(key).then(function (value) {
        _this10.storage.removeItem(_this10.id + key);
...
},{}],"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/SessionStorage.js":[function(require,module,exports) {
"use strict";
 ...
 * @class
 */
var SessionStorage = /*#__PURE__*/function (_LocalStorage) {
  _inherits(SessionStorage, _LocalStorage);

  var _super = _createSuper(SessionStorage);
...
},{"./LocalStorage":"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/LocalStorage.js"}],"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/IndexedDB.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(IndexedDB, [{
    ...
    value: function open() {
      ...
      if (this.storage instanceof IDBDatabase) {
        ...
        this.storage = new Promise(function (resolve, reject) {
          var upgradesToApply = [];
          var storage = window.indexedDB.open(_this.name, _this.numericVersion);

          storage.onerror = function (event) {
            reject(event);
          };

          storage.onsuccess = function (event) {
            resolve({
          ...
          storage.onupgradeneeded = function (event) {
            ...
            if (event.oldVersion < 1) {
              ...
              var store = event.target.result.createObjectStore(_this.store, _this.props);

              for (var _i = 0, _Object$keys = Object.keys(_this.index); _i < _Object$keys.length; _i++) {
                var index = _Object$keys[_i];
                store.createIndex(_this.index[index].name, _this.index[index].field, _this.index[index].props);
              }
            } else {
              // Check what upgrade functions have been declared in their respective order
              var availableUpgrades = Object.keys(_this.upgrades).sort(); // Find the first update that needs to be applied to the database given
          ...
          return new Promise(function (resolve) {
            ...
            _this._upgrade(upgrades, res, event);
          });
        });
        return this.storage;
      }
    ...
    value: function set() {
      ...
      return this.open().then(function () {
        return new Promise(function (resolve, reject) {
          var transaction = _this2.storage.transaction(_this2.store, 'readwrite').objectStore(_this2.store);

          var op;

          if (key !== null) {
            op = transaction.put(Object.assign({}, {
              id: key
            }, value));
          } else {
          ...
          op.addEventListener('success', function (event) {
            resolve({
              key: event.target.result,
              value: value
            });
          });
          op.addEventListener('error', function (event) {
            reject(event);
          });
        });
      });
    ...
    value: function update(key, value) {
      ...
      return this.get(key).then(function (currentValue) {
        ...
        return new Promise(function (resolve, reject) {
          var transaction = _this3.storage.transaction(_this3.store, 'readwrite').objectStore(_this3.store);

          var op = transaction.put(Object.assign({}, currentValue, value));
          op.addEventListener('success', function (event) {
            resolve({
              key: event.target.result,
              value: value
    ...
    value: function get(key) {
      ...
      return this.open().then(function () {
        return new Promise(function (resolve, reject) {
          var transaction = _this4.storage.transaction(_this4.store).objectStore(_this4.store);

          var op = transaction.get(key);
          op.addEventListener('success', function (event) {
    ...
    value: function getAll() {
      ...
      return this.open().then(function () {
        return new Promise(function (resolve, reject) {
          var transaction = _this5.storage.transaction(_this5.store).objectStore(_this5.store);

          var op = transaction.getAll();
          op.addEventListener('success', function (event) {
            resolve(event.target.result);
          });
          op.addEventListener('error', function (event) {
    ...
    key: "contains",
    value: function contains(key) {
      return this.get(key).then(function (keys) {
        if (keys.includes(key)) {
          Promise.resolve();
        } else {
          return Promise.reject();
    ...
    key: "_upgrade",
    value: function _upgrade(upgradesToApply, resolve, event) {
      var _this6 = this;

      // Check if there are still upgrades to apply
      if (upgradesToApply.length > 0) {
        this.upgrades[upgradesToApply[0]].call(this, this, event).then(function () {
          _this6._upgrade(upgradesToApply.slice(1), resolve, event);
        }).catch(function (e) {
          return console.error(e);
        });
      } else {
    ...
    value: function keys() {
      ...
      return this.open().then(function () {
        return new Promise(function (resolve, reject) {
          var transaction = _this7.storage.transaction(_this7.store, 'readwrite').objectStore(_this7.store);

          var op = transaction.getAllKeys();
          op.addEventListener('success', function (event) {
            resolve(event.target.result);
          }, false);
          op.addEventListener('error', function (event) {
    ...
    value: function remove(key) {
      ...
      return this.get(key).then(function (value) {
        return new Promise(function (resolve, reject) {
          var transaction = _this8.storage.transaction(_this8.store, 'readwrite').objectStore(_this8.store);

          var op = transaction.delete(key);
          op.addEventListener('success', function () {
            resolve(value);
          }, false);
          op.addEventListener('error', function (event) {
            reject(event);
    ...
    value: function clear() {
      ...
      return this.open().then(function () {
        return new Promise(function (resolve, reject) {
          var transaction = _this9.storage.transaction(_this9.store, 'readwrite').objectStore(_this9.store);

          var op = transaction.clear();
          op.addEventListener('success', function () {
            resolve();
          }, false);
          op.addEventListener('error', function (event) {
...
},{}],"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/RemoteStorage.js":[function(require,module,exports) {
"use strict";
...
var RemoteStorage = /*#__PURE__*/function () {
  ...
  function RemoteStorage(_ref) {
    ...
    this.version = version;
    this.store = store;
    this.endpoint = "".concat(endpoint).concat(store, "/");
    this.props = props;
  }
  /**
   * Open the Storage Object
  ...
  _createClass(RemoteStorage, [{
    ...
    value: function set(key, value) {
      ...
      return this.open().then(function () {
        return _this.storage.post(_this.endpoint + key, value, _this.props).then(function (response) {
          return Promise.resolve({
            key: key,
    ...
    value: function update(key, value) {
      ...
      return this.get(key).then(function (currentValue) {
        return _this2.storage.put(_this2.endpoint + key, Object.assign({}, currentValue, value), _this2.props).then(function (response) {
          return Promise.resolve({
            key: key,
            response: response.json()
          });
    ...
    value: function get(key) {
      ...
      return this.open().then(function () {
        return _this3.storage.json(_this3.endpoint + key, {}, _this3.props);
      });
    }
    /**
     * Retrieves all the values in the space in a key-value JSON object
    ...
    value: function getAll() {
      ...
      return this.open().then(function () {
        return _this4.storage.json(_this4.endpoint, {}, _this4.props);
      });
    }
    /**
    ...
    value: function keys() {
      ...
      return this.open().then(function () {
        return _this5.storage.json(_this5.endpoint, {
          keys: true
        }, _this5.props);
      });
    }
    ...
    value: function remove(key) {
      ...
      return this.open().then(function () {
        return _this6.storage.delete(_this6.endpoint + key, {}, _this6.props).then(function (response) {
    ...
    value: function clear() {
      ...
      return this.open().then(function () {
        return _this7.storage.delete(_this7.endpoint, {}, _this7.props);
      });
    }
  }]);
...
},{"./../Request":"../node_modules/@aegis-framework/artemis/src/Request.js"}],"../node_modules/@aegis-framework/artemis/src/Space.js":[function(require,module,exports) {
"use strict";
...
var _LocalStorage = require("./SpaceAdapter/LocalStorage");

var _SessionStorage = require("./SpaceAdapter/SessionStorage");

var _IndexedDB = require("./SpaceAdapter/IndexedDB");

var _RemoteStorage = require("./SpaceAdapter/RemoteStorage");
...
var SpaceAdapter = {
  ...
  RemoteStorage: _RemoteStorage.RemoteStorage
};
/**
...
exports.SpaceAdapter = SpaceAdapter;
...
var Space = /*#__PURE__*/function () {
   ...
   */
  function Space() {
    var adapter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : SpaceAdapter.LocalStorage;
    ...
    this._configuration = Object.assign({}, {
      ...
      version: '',
      store: ''
    }, configuration); // Set up the adapter instance to use

    this.adapter = new adapter(this._configuration); // This object stores all the callbacks the user can define for the
    // space operations
  ...
  _createClass(Space, [{
    ...
    value: function open() {
      ...
      return this.adapter.open().then(function () {
    ...
    value: function set(key, value) {
      ...
      for (var _i = 0, _Object$keys = Object.keys(this.transformations); _i < _Object$keys.length; _i++) {
      ...
      return this.adapter.set(key, value).then(function (_ref) {
        var key = _ref.key,
            value = _ref.value;

        var _iterator = _createForOfIteratorHelper(_this2.callbacks.create),
            _step;
    ...
    value: function update(key, value) {
      ...
      // Apply all set transformations to the value
      for (var _i2 = 0, _Object$keys2 = Object.keys(this.transformations); _i2 < _Object$keys2.length; _i2++) {
      ...
      return this.adapter.update(key, value).then(function (_ref2) {
        var key = _ref2.key,
            value = _ref2.value;

        var _iterator2 = _createForOfIteratorHelper(_this3.callbacks.update),
            _step2;
    ...
    value: function get(key) {
      ...
      return this.adapter.get(key).then(function (value) {
        // Apply all get transformations to the value
        for (var _i3 = 0, _Object$keys3 = Object.keys(_this4.transformations); _i3 < _Object$keys3.length; _i3++) {
          var id = _Object$keys3[_i3];

          if (typeof _this4.transformations[id].get === 'function') {
            value = _this4.transformations[id].get.call(null, key, value);
          }
        }
    ...
    value: function getAll() {
      ...
      return this.adapter.getAll().then(function (values) {
        // Apply all get transformations to the value
        for (var _i4 = 0, _Object$keys4 = Object.keys(values); _i4 < _Object$keys4.length; _i4++) {
          var key = _Object$keys4[_i4];

          for (var _i5 = 0, _Object$keys5 = Object.keys(_this5.transformations); _i5 < _Object$keys5.length; _i5++) {
            var id = _Object$keys5[_i5];

            if (typeof _this5.transformations[id].get === 'function') {
              values[key] = _this5.transformations[id].get.call(null, key, values[key]);
            }
          }
        }
    ...
    value: function each(callback) {
      ...
      return this.getAll().then(function (values) {
        var promises = [];

        for (var _i6 = 0, _Object$keys6 = Object.keys(values); _i6 < _Object$keys6.length; _i6++) {
          var i = _Object$keys6[_i6];
          promises.push(callback.call(_this6, i, values[i]));
        }
    ...
    value: function upgrade(oldVersion, newVersion, callback) {
      ...
      return this.adapter.upgrade(oldVersion, newVersion, callback).then(function () {
    ...
    value: function addTransformation(_ref3) {
      var id = _ref3.id,
          get = _ref3.get,
          set = _ref3.set;
    ...
    key: "removeTransformation",
    value: function removeTransformation(id) {
    ...
    value: function remove(key) {
      ...
      return this.adapter.remove(key).then(function (value) {
        // Run the callback for deletions
        var _iterator3 = _createForOfIteratorHelper(_this8.callbacks.delete),
            _step3;
...
exports.Space = Space;
},{"./SpaceAdapter/LocalStorage":"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/LocalStorage.js","./SpaceAdapter/SessionStorage":"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/SessionStorage.js","./SpaceAdapter/IndexedDB":"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/IndexedDB.js","./SpaceAdapter/RemoteStorage":"../node_modules/@aegis-framework/artemis/src/SpaceAdapter/RemoteStorage.js"}],"../node_modules/@aegis-framework/artemis/src/Text.js":[function(require,module,exports) {
"use strict";
...
var Text = /*#__PURE__*/function () {
  ...
  _createClass(Text, null, [{
    ...
    key: "suffix",
    value: function suffix(key, text) {
      var suffix = '';
    ...
    key: "prefix",
    value: function prefix(key, text) {
      var prefix = '';
      var position = text.indexOf(key);
    ...
    key: "friendly",
    value: function friendly(text) {
      var regex = [/[áàâãªä]/, /[ÁÀÂÃÄ]/, /[ÍÌÎÏ]/, /[íìîï]/, /[éèêë]/, /[ÉÈÊË]/, /[óòôõºö]/, /[ÓÒÔÕÖ]/, /[úùûü]/, /[ÚÙÛÜ]/, /ç/, /Ç/, /ñ/, /Ñ/, /_/, /[’‘‹›<>']/, /[“”«»„"]/, /[(){}[\]]/, /[?¿!¡#$%&^*´`~/°|]/, /[,.:;]/, / /];
      var replacements = ['a', 'A', 'I', 'i', 'e', 'E', 'o', 'O', 'u', 'U', 'c', 'C', 'n', 'N', '-', '', '', '', '', '', '-'];
...
exports.Text = Text;
},{}],"../node_modules/@aegis-framework/artemis/src/Util.js":[function(require,module,exports) {
"use strict";
...
var Util = /*#__PURE__*/function () {
  ...
  _createClass(Util, null, [{
     ...
     */
    function callAsync(callable, context) {
      try {
        ...
        var result = callable.apply(context, args); // Check if the function returned a simple value or a Promise
...
exports.Util = Util;
},{}],"../node_modules/@aegis-framework/artemis/index.js":[function(require,module,exports) {
"use strict";
...
var _FileSystem = require("./src/FileSystem");
...
var _Platform = require("./src/Platform");
...
var _Preload = require("./src/Preload");

Object.keys(_Preload).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _Preload[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _Preload[key];
...
},{"./src/Debug":"../node_modules/@aegis-framework/artemis/src/Debug.js","./src/DOM":"../node_modules/@aegis-framework/artemis/src/DOM.js","./src/FileSystem":"../node_modules/@aegis-framework/artemis/src/FileSystem.js","./src/Form":"../node_modules/@aegis-framework/artemis/src/Form.js","./src/Platform":"../node_modules/@aegis-framework/artemis/src/Platform.js","./src/Preload":"../node_modules/@aegis-framework/artemis/src/Preload.js","./src/Request":"../node_modules/@aegis-framework/artemis/src/Request.js","./src/Space":"../node_modules/@aegis-framework/artemis/src/Space.js","./src/Text":"../node_modules/@aegis-framework/artemis/src/Text.js","./src/Util":"../node_modules/@aegis-framework/artemis/src/Util.js"}],"../src/lib/FancyError.js":[function(require,module,exports) {
"use strict";
...
/* global Prism */
var FancyError = /*#__PURE__*/function () {
  function FancyError() {
    _classCallCheck(this, FancyError);
  }

  _createClass(FancyError, null, [{
    key: "init",
    value: function init() {}
  }, {
    key: "pop",
    ...
    value: function show() {
      ...
      var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'An error has ocurred! Please check the console so you get more insight.';
      var props = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

      if ((typeof MonogatariDebug === "undefined" ? "undefined" : _typeof(MonogatariDebug)) === 'object') {
        var id = _artemis.Util.uuid();
    ...
    value: function render() {
      ...
      var html = '<div class="error-section">';

      for (var _i = 0, _Object$keys = Object.keys(props); _i < _Object$keys.length; _i++) {
        var key = _Object$keys[_i];

        if (typeof props[key] === 'string' || typeof props[key] === 'number') {
          html += "<p><b>".concat(key, "</b>: ").concat(props[key], "</p>");
        } else if (props[key] instanceof Array) {
          html += "<details open><summary><b>".concat(key, "</b>:</summary><ul>");

          var _iterator = _createForOfIteratorHelper(props[key]),
              _step;
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              html += "<code class='language-markup'>".concat(_item.outerHTML.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;'), "</code>");
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
      ...
      for (var _i2 = 0, _Object$keys2 = Object.keys(props); _i2 < _Object$keys2.length; _i2++) {
        ...
        if (_typeof(props[_key]) === 'object' && !(props[_key] instanceof Array) && !(props[_key] instanceof NodeList)) {
          html += "<hr class='separator--material'/><h3>".concat(_artemis.Text.capitalize(_key), "</h3><div class='error-section'>");

          for (var _i3 = 0, _Object$keys3 = Object.keys(props[_key]); _i3 < _Object$keys3.length; _i3++) {
            var property = _Object$keys3[_i3];

            if (property.indexOf('_') === 0) {
              html += "<p>".concat(props[_key][property], "</p>");
            } else {
              if (typeof props[_key][property] === 'string' || typeof props[_key][property] === 'number') {
                html += "<p><b>".concat(property, "</b>: ").concat(props[_key][property], "</p>");
              } else if (props[_key][property] instanceof Array) {
                html += "<details open><summary><b>".concat(_key, "</b>:</summary><ul>");

                var _iterator3 = _createForOfIteratorHelper(props[_key]),
                    _step3;

                try {
                  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                    var _item2 = _step3.value;
                    html += "<li>".concat(_item2, "</li>");
                  }
                } catch (err) {
                  _iterator3.e(err);
                } finally {
                ...
                html += '</ul></details></p>';
              } else if (props[_key][property] instanceof NodeList) {
                html += "<p><b>".concat(property, "</b>:<br><pre>");
                ...
                try {
                  for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                    ...
                    html += "<code class='language-markup'>".concat(_item3.outerHTML.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;'), "</code>");
                  }
                } catch (err) {
                  _iterator4.e(err);
                } finally {
...
FancyError.queue = [];
},{"@aegis-framework/artemis":"../node_modules/@aegis-framework/artemis/index.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./vendor/prism.js");

var _FancyError = require("../src/lib/FancyError");
...
window.addEventListener('error', function (event) {
  var message = event.message,
      lineno = event.lineno,
      filename = event.filename; // Once the DOM is ready, a Fancy Error will be shown providing more information

  (0, _artemis.$_ready)(function () {
    _FancyError.FancyError.show('An Unknown Error Occurred', message, {
      'File': filename,
      'Line': lineno,
      'Help': {
...
},{"./vendor/prism.js":"vendor/prism.js","../src/lib/FancyError":"../src/lib/FancyError.js","@aegis-framework/artemis":"../node_modules/@aegis-framework/artemis/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","index.js"], "MonogatariDebug")
